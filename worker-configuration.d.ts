/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1ed60a7ccdacc3e142c93a9770f8ef60)
// Runtime types generated with workerd@1.20260923.1 2026-09-01
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	MODO: "automatico";
	XML_MODO: "automatico";
	CANCELAMENTO_MODO: "automatico";
	ESTOQUE_MODO: "automatico";
	PRECO_MODO: "automatico";
	MELI_API: "https://api.mercadolibre.com";
	MELI_USER_ID: "3474041384";
	SANKHYA_API: "https://api.sankhya.com.br";
	MELI_TOKEN: DurableObjectNamespace<import("./src/index").MeliToken>;
	STORE: DurableObjectNamespace<import("./src/index").Store>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MeliToken" | "Store";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODO" | "XML_MODO" | "CANCELAMENTO_MODO" | "ESTOQUE_MODO" | "PRECO_MODO" | "MELI_API" | "MELI_USER_ID" | "SANKHYA_API">> {}
}
